---
source: https://jellyfin.org/docs/general/server/metadata/nfo/
extracted: 2026-01-24T19:58:05+00:00
---

Title: Local .nfo metadata | Jellyfin

URL Source: https://jellyfin.org/docs/general/server/metadata/nfo/

Markdown Content:
Jellyfin can read and write local .nfo metadata files to import or export metadata from and to other programs and tools.

Naming .nfo files[​](https://jellyfin.org/docs/general/server/metadata/nfo/#naming-nfo-files "Direct link to Naming .nfo files")
--------------------------------------------------------------------------------------------------------------------------------
...
| thumb | please see the [section about images](https://jellyfin.org/docs/general/server/metadata/nfo/#image-paths-and-urls-in-nfo-files) |
| fanart | please see the [section about images](https://jellyfin.org/docs/general/server/metadata/nfo/#image-paths-and-urls-in-nfo-files) |
...
Image paths and URLs in .nfo files[​](https://jellyfin.org/docs/general/server/metadata/nfo/#image-paths-and-urls-in-nfo-files "Direct link to Image paths and URLs in .nfo files")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
